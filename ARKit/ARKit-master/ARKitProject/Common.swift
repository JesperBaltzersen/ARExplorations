...
extension SCNNode {
    ...
    class func textNode(text: String) -> SCNNode {
        ...
        // put text node in billboard node
...
extension SCNView {
    ...
    // If light estimation is enabled, update
    // the intensity of the model's lights and the environment map
